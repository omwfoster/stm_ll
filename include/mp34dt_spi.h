...
#define AUDIO_IN_SPI3_INSTANCE                        SPI3
#define AUDIO_IN_SPI3_CLK_ENABLE()           __SPI3_CLK_ENABLE()
#define AUDIO_IN_SPI3_SCK_GPIO_CLK_ENABLE()  __GPIOC_CLK_ENABLE()
#define AUDIO_IN_SPI3_MISO_GPIO_CLK_ENABLE() __GPIOC_CLK_ENABLE()
#define AUDIO_IN_SPI3_MOSI_GPIO_CLK_ENABLE() __GPIOC_CLK_ENABLE()
#define AUDIO_IN_SPI3_FORCE_RESET()          __SPI3_FORCE_RESET()
#define AUDIO_IN_SPI3_RELEASE_RESET()        __SPI3_RELEASE_RESET()
#define AUDIO_IN_SPI3_SCK_PIN                GPIO_PIN_10
#define AUDIO_IN_SPI3_SCK_GPIO_PORT          GPIOC
#define AUDIO_IN_SPI3_SCK_AF                 GPIO_AF6_SPI3
#define AUDIO_IN_SPI3_MOSI_PIN               GPIO_PIN_12
#define AUDIO_IN_SPI3_MOSI_GPIO_PORT         GPIOC
#define AUDIO_IN_SPI3_MOSI_AF                GPIO_AF6_SPI3

/* SPI DMA definitions */
#define AUDIO_IN_SPI3_DMAx_CLK_ENABLE() __DMA1_CLK_ENABLE()
#define AUDIO_IN_SPI3_RX_DMA_CHANNEL    DMA_CHANNEL_0
#define AUDIO_IN_SPI3_RX_DMA_STREAM     DMA1_Stream2
#define AUDIO_IN_SPI3_DMA_RX_IRQn       DMA2_Stream2_IRQn
#define AUDIO_IN_SPI3_DMA_RX_IRQHandler DMA2_Stream2_IRQHandler


/* SPI Configuration defines */
#define AUDIO_IN_SPI1_INSTANCE                        SPI1
#define AUDIO_IN_SPI1_CLK_ENABLE()           __SPI1_CLK_ENABLE()
#define AUDIO_IN_SPI1_SCK_GPIO_CLK_ENABLE()  __GPIOA_CLK_ENABLE()
#define AUDIO_IN_SPI1_MISO_GPIO_CLK_ENABLE() __GPIOA_CLK_ENABLE()
#define AUDIO_IN_SPI1_MOSI_GPIO_CLK_ENABLE() __GPIOA_CLK_ENABLE()
#define AUDIO_IN_SPI1_FORCE_RESET()          __SPI1_FORCE_RESET()
#define AUDIO_IN_SPI1_RELEASE_RESET()        __SPI1_RELEASE_RESET()
#define AUDIO_IN_SPI1_SCK_PIN                GPIO_PIN_5
#define AUDIO_IN_SPI1_SCK_GPIO_PORT          GPIOA
#define AUDIO_IN_SPI1_SCK_AF                 GPIO_AF5_SPI1
#define AUDIO_IN_SPI1_MOSI_PIN               GPIO_PIN_7
#define AUDIO_IN_SPI1_MOSI_GPIO_PORT         GPIOA
#define AUDIO_IN_SPI1_MOSI_AF                GPIO_AF5_SPI1

/* SPI DMA definitions */
#define AUDIO_IN_SPI1_DMAx_CLK_ENABLE() __DMA2_CLK_ENABLE()
#define AUDIO_IN_SPI1_RX_DMA_CHANNEL    DMA_CHANNEL_3
#define AUDIO_IN_SPI1_RX_DMA_STREAM     DMA2_Stream2
#define AUDIO_IN_SPI1_DMA_RX_IRQn       DMA2_Stream2_IRQn
#define AUDIO_IN_SPI1_DMA_RX_IRQHandler DMA2_Stream2_IRQHandler
